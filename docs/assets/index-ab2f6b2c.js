...
`);if(e===null||xs(e)!=="object")throw new Error(t);if(Object.keys(e).length===1&&typeof e.advancedFraudSignals=="boolean")return e;throw new Error(t)},Os=!1,ct=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];Os=!0;var r=Date.now();return zl(Cs).then(function(s){return Yl(s,t,r)})};ct.setLoadParameters=function(e){if(Os)throw new Error("You cannot change load parameters after calling loadStripe");Cs=Jl(e)};/**
...
`]},media:void 0})},gc=Ps({render:Ls,staticRenderFns:hc},mc,pc,"data-v-171d7aec",!1,void 0,!1,Is,void 0,void 0);var yc={install:function(e,t){var n,r,s,i,o,l,u;return Re.async(function(f){for(;;)switch(f.prev=f.next){case 0:n=t.pk,r=t.stripeAccount,s=t.apiVersion,i=t.locale,o=t.elementsOptions,(l=window.Stripe(n,{stripeAccount:r,apiVersion:s,locale:i})).registerAppInfo(It),u=l.elements(o),e.prototype.$stripe=l,e.prototype.$stripeElements=u;case 6:case"end":return f.stop()}})}};Ss=ut.StripeCheckout=Gl,ut.StripeElementCard=uc,ut.StripeElementPayment=gc,ut.StripeElementsPlugin=yc,ut.StripePlugin=Dl;const bc=(e,t)=>{const n=e.__vccOpts||e;for(const[r,s]of t)n[r]=s;return n},vc="https://github.com/BarakBinyamin/Button/archive/refs/heads/main.zip",Lr="17baface-7b1c-4b5a-9f19-db3d2401070b",_c={components:{StripeCheckout:Ss},data(){return{public_key:"pk_live_51MnGvpE4Sr7PmQRtfjprJAOfOJqR274kiclk6fOqsiBVtJ54IToc5yHotr3lRSWP3zptk3RBjkiy2WSVFhu6Eo7H00mDvqUxK8",product_price_id:"price_1Mnt4aE4Sr7PmQRtYMS5LNzT",lineitems:[{price:this.product_price_id,quantity:1}],cancelURL:`${window.location.origin}${window.location.pathname}?success=false`,succuessURL:`${window.location.origin}${window.location.pathname}?success=${Lr}`,paramExists:"",success:""}},mounted(){let e=new URLSearchParams(window.location.search);this.paramExists=e.has("success"),this.success=e.get("success")===Lr},methods:{submit(){this.$refs.checkoutRef.redirectToCheckout()},download(){window.open(vc)}}},Ec={key:0},wc={key:0,class:"title"},Ac={key:1,class:"title"},Sc={key:2},xc=Fo('<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M12 16L12 8" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M9 13L11.913 15.913V15.913C11.961 15.961 12.039 15.961 12.087 15.913V15.913L15 13" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M3 15L3 16L3 19C3 20.1046 3.89543 21 5 21L19 21C20.1046 21 21 20.1046 21 19L21 16L21 15" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>',1),Cc=[xc];function Tc(e,t,n,r,s,i){const o=lo("stripe-checkout");return We(),tt(Oe,null,[s.paramExists?(We(),tt("div",Ec,[s.success?(We(),tt("div",wc,"Transaction succeeded!")):(We(),tt("div",Ac,"Transaction failed, try again...")),s.success?(We(),tt("div",Sc,Cc)):vr("",!0)])):vr("",!0),!s.paramExists||!s.success?(We(),tt("div",{key:1,class:"button",onClick:t[0]||(t[0]=(...l)=>i.submit&&i.submit(...l))},"Buy this button")):(We(),tt("div",{key:2,class:"button",onClick:t[1]||(t[1]=(...l)=>i.download&&i.download(...l))},"Download the code!")),Fe(o,{ref:"checkoutRef",mode:"payment",pk:s.public_key,"line-items":[{price:s.product_price_id,quantity:1}],"success-url":s.succuessURL,"cancel-url":s.cancelURL,onLoading:t[2]||(t[2]=l=>e.loading=l)},null,8,["pk","line-items","success-url","cancel-url"])],64)}const Oc=bc(_c,[["render",Tc]]),Pc=gl(Oc);Pc.mount("#app");
